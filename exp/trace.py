...
class TraceExp:
    def __init__(self, feature, epochs=100, batch_size=16, patience=7, lr=0.001, w=30, gamma=0.1, r=0.5, verbose=True):
        ...
        self.modelpath = './checkpoint/trace_model.pkl'
        self.thresholdpath = './checkpoint/trace_threshold.pkl'
        self.trainimgpath = './result/img/trace_train_loss.png'
        self.validimgpath = './result/img/trace_valid_loss.png'
        self.validresultpath = './result/result/trace_result_valid.csv'
        self.resultpath = './result/result/trace_result.csv'
